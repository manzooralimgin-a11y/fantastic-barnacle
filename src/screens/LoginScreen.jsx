...
function SuccessOverlay({ guest }) {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-[#0c1718] to-[#0f2320] z-10 animate-[fadeIn_0.3s_ease-out]">
...
export default function LoginScreen() {
  ...
  return (
    <div className="relative min-h-dvh flex flex-col overflow-hidden bg-gradient-to-br from-[#0c1718] via-[#0f2320] to-[#1a3d35]">
      {/* Success overlay */}
      {loginSuccess && guest && <SuccessOverlay guest={guest} />}

      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-green-400/20 blur-3xl" />
        <div className="absolute top-1/2 -left-32  w-80 h-80 rounded-full bg-green-300/10 blur-3xl" />
        <div className="absolute -bottom-20 right-20 w-64 h-64 rounded-full bg-green-500/20 blur-3xl" />
        {/* Subtle grid pattern */}
        <div
      ...
      <div className="relative flex-1 flex flex-col px-5 pt-14 pb-10">
        ...
        <div className="flex flex-col items-center gap-3 mb-10">
          <div className="w-16 h-16 rounded-2xl bg-white/15 border border-white/25 flex items-center justify-center shadow-2xl backdrop-blur-sm">
            <img src="/logo.webp" alt="Das ELB" className="w-10 h-10 object-contain" />
          </div>
          <div className="text-center">
            <h1 className="text-white text-2xl font-bold tracking-tight">das elb</h1>
            <p className="text-white/50 text-xs mt-0.5 tracking-widest uppercase">Guest Portal</p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
            ...
            <button
              ...
              className={[
                ...
                'bg-white text-green-900 shadow-lg shadow-green-900/30',
